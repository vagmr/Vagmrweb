<?php
    ...
    $s = file_get_contents("https://www.sapi.run/hero/select.php?hero=".$name."&type=aqq");
    $qqHero = json_decode($s, true);
    
    $s = file_get_contents("https://www.sapi.run/hero/select.php?hero=".$name."&type=awx");
    $wxHero = json_decode($s, true);
    
    $s = file_get_contents("https://www.sapi.run/hero/select.php?hero=".$name."&type=iqq");
    $iosqqHero = json_decode($s, true);
    
    $s = file_get_contents("https://www.sapi.run/hero/select.php?hero=".$name."&type=iwx");
                        ...
                        <div class="layui-col-md3">
                            <div class="layui-card">
                                ...
                                <div class="layui-card-body" style="text-align:center">
                                    <div class="layadmin-backlog">
                                        <p>小程序功能更多 谢谢支持</p>
                                        <img src='https://' style="height:120px"/>
                                    </div>
                                </div>
                            </div>
                        </div>
